...
os.system("xdg-open https://t.me/KGF_TEAM_CYBER")
logo=(f"""{white}───────────────────────────────────────
{red}|{green}  ┏┓┏┓┏┓┏┓┏┓┳┓ ┳┏┓┓ ┏┓┳┳┓  {red}| {green} 4     {red} |
{red}|{green}  ┗┓┣┫┏┛┏┛┣┫┃┃ ┃┗┓┃ ┣┫┃┃┃  {red}|{white}    0    {red}|
{red}|{green}  ┗┛┛┗┗┛┗┛┛┗┻┛ ┻┗┛┗┛┛┗┛ ┗  {red}|   {green}   4 {red} |
{white}───────────────────────────────────────
{red}|{white}={red}|{green} DEVELOPER {white}: {green}︎SAZZAD ISLAM SANE
{red}|{white}={red}|{green} TOOLTYPE {white} : {green}FREE {red}({green}FILE {white}& {green}RANDOM{red})
{red}|{white}={red}|{green} SC SEND   {white}: {white}︎KALYAN KING > https://t.me/KGF_TEAM_CYBER
{white}───────────────────────────────────────""")
